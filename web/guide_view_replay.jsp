    ...
    <body>
        <div class="container">
                                                       ...
                                                       <form method="post" align="center"> 
                                                           ...
                                                           <br>
                                                                <table align="center" >
                                                                      <a style="background-color:#5bc0de !important;border:none; color:#fff;margin-top: 20px;" class="btn btn-flat btn-lg pull-right" href="guideaddcomplaint.jsp#active">New Complaint </a><br><br><br><br>	
                                                                <tr>
