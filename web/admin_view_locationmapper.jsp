                                             ...
                                             if(c1.rs.next())
                                             {
                                                 out.println(c1.rs.getString("district"));
                                                   ...
                                                   <td><%out.println(rs.getString("location"));%></td>  
                                                    ...
                                                    <td>
                                                    <%
                                        if(rs.getString("stat").matches("approved"))
                                         {
                                            %>
                                            <a href="admin_loc_approval.jsp?id=<%=rs.getString("lo_id")%>"><span class="glyphicon glyphicon-ok " title="Approve"></span></a>
                                                           
                                                            <a href="admin_loc_reject.jsp?id=<%=rs.getString("lo_id")%>"><span class="glyphicon glyphicon-remove" title="Reject"></span></a></td> 
