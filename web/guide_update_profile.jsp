                            ...
                            <form>
                               ...
                               <div class="form-group">
                                ...
                                <%
                                 ...
                                 String query="UPDATE `c_register` SET `about`='"+request.getParameter("n4")+"',`c_phno`='"+request.getParameter("n3")+"',`c_email`='"+request.getParameter("n2")+"' Where `log_id`='"+us_id+"'";
  obj.InsertUpdate(query);
  
             out.println("<script type=\"text/javascript\">");
      out.println("alert('Updated Sucessfully');");
     out.println("window.location.href ='traveler_home.jsp';");
     out.println("</script>");
            }
