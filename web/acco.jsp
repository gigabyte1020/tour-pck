...
<form method="post"  >
    <a style="background-color:#5bc0de !important;border:none; color:#fff" class="btn btn-flat btn-lg pull-right" href="guide_view_replay.jsp">List Registered Complaint</a><br>                             
 ...
 <label  class="col-sm-3"style="margin-left: 100px">Title</label>
    ...
    <%
       ...
       if(request.getParameter("t3")!=null)
       {
        ...
        c.InsertUpdate("INSERT INTO `package`( log_id,`title`, `msg`,`s_id`,`d_id`,`l_id`) VALUES ('"+session.getAttribute("l_id")+"','"+request.getParameter("t1")+"','"+request.getParameter("t2")+"','"+request.getParameter("s_id")+"','"+request.getParameter("d_id")+"','"+request.getParameter("l_id")+"')");
