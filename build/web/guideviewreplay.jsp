    ...
    <body>
        <div class="container">
                                                       ...
                                                       <form method="post" align="center"> 
                                                           ...
                                                           <br>
                                                                <table align="center" >
                                                                      <a style="background-color:#5bc0de !important;border:none; color:#fff;margin-top: 20px;" class="btn btn-flat btn-lg pull-right" href="guideviewpackage.jsp#active">Packages </a><br><br><br><br>	
                                                                <tr>
...
<%-- <td><font color="BLUE"> Reject</td>--%>
        ...
        String ui=session.getAttribute("l_id").toString();
                                             ResultSet rs,rs1,rs2;
                                                     ...
                                                     String qry="SELECT * FROM `package` inner join request on package.pack_id=request.pck_id where  g_id='"+session.getAttribute("l_id")+"' ";
