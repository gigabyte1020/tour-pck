...
<jsp:include page="header.jsp"/>
 <section class="team" id="team">
     ...
     <div class="team-heading text-center" >
							<h2 style='color: white'>Guide Sign up</h2>
</div>
                                          <form method="post">
                    ...
                    <option value="<%=c1.rs.getString("state_id")%>"><%out.print(c1.rs.getString("state"));}%></option>%>
                                                         ...
                                                         <div class="form-group" id="dt" >
                                                                <select name="n3" style="width: 400px;height: 35px "><option value="none">-select District-</option></select></td>
                                                               </select>
                                                            </div> <br><br><br>
                                 ...
                                 <%
                                    ConnectionCls obj=new ConnectionCls();
                                                      ...
                                                      if(request.getParameter("submit")!=null)
                                                      {
                                                          ...
                                                          String query1="INSERT INTO `login`(`user_name`, `password`, `role`,`email`) VALUES ('"+request.getParameter("n5")+"','"+request.getParameter("n6")+"','guide','"+request.getParameter("n2")+"')";
        // out.println(query1);
        ...
        //   out.println("fdgdf");
                                             ...
                                             rs.beforeFirst();
                                                ...
                                                //
                                 String query="INSERT INTO `c_register`(`log_id`, `c_name`, `c_add`, `c_phno`, `c_email`, `c_status`,`about`,`date`,`ceoname`,`pic`,`role`) VALUES ('"+uid+"','"+request.getParameter("n1")+"','"+request.getParameter("n4")+"','"+request.getParameter("n33")+"','"+request.getParameter("n2")+"','0','"+request.getParameter("n7")+"','"+request.getParameter("n9")+"','"+request.getParameter("n3")+"','null','guide')";
