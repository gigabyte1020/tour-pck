...
<%-- <td><font color="BLUE"> Reject</td>--%>
        ...
        String ui=session.getAttribute("l_id").toString();
                                             ResultSet rs,rs1,rs2;
                                                     ...
                                                     String qry="SELECT * FROM `user_request` where status='guideapproved'  ";
                                                 ...
                                                 while(rs1.next())
                                                 {
                                                     ...
                                                     <td>
                                                         <% 
                                                            ...
                                                            <td>
                                                                <%
                                                                out.print(rs1.getString("from"));
                                                                %>
                                                            </td>
                                                             <td>
                                                               <%
                                                                out.print(rs1.getString("to"));
                                                                %>
                                                            </td>
                                                            <td>
                                                                <%
                                                                out.print("G-"+rs1.getString("g_id"));
                                                                %>
                                                            </td>
                                                            <td>
                                                            <%
                                                             ...
                                                             {
                                                            %>
                                                            <a href="userreqapprove.jsp?id=<%=rs1.getString("u_req_id")%>">Approve</a>
